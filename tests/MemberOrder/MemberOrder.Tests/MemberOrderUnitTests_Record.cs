...
[TestClass]
public class MemberOrderUnitTest_Record
{
    [TestMethod]
    public async Task Analyzer_AllCategoriesModifiersAndNamesInOrder_NoDiagnostics()
    {
        ...
        public record MyRecord
        {
            ...
            static MyRecord() { }
            public MyRecord() { }
            internal MyRecord(int a, int b) { }
            protected internal MyRecord(int a) { }
            private protected MyRecord(int a, int b, int c, int d) { }
            protected MyRecord(int a, int b, int c) { }
            private MyRecord(int a, int b, int c, int d, int e) { }
    ...
    [TestMethod]
    public async Task Analyzer_DeconstructorBeforeConstructor_SingleDiagnostic()
    {
        // Arrange
        const string sourceText = @"
        public record MyRecord
    ...
    [TestMethod]
    public async Task Analyzer_MethodBeforeDeconstructor_SingleDiagnostic()
    {
        // Arrange
        const string sourceText = @"
        public record MyRecord
